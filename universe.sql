...
CREATE TABLE five(five_id SERIAL PRIMARY KEY,
                     name VARCHAR(30) UNIQUE,
                     description TEXT,
                     age INT NOT NULL,
                     distance_in_au INT,
...
INSERT INTO five("name",description,age,distance_in_au,probability_of_life,is_spherical) VALUES
		('something','an example',1,121,0.00,false),
		('somethin_else','an example',1,121,0.00,false),
		('anotherthing','an example',1,121,0.00,false);
...
INSERT INTO galaxy ("name",description,age,distance_in_au,probability_of_life,is_spherical) VALUES
	 ...
	 ('Cletus','Yeehaw',10,77000000,0.87,true);
	 
INSERT INTO star ("name",description,age,distance_in_au,probability_of_life,is_spherical,galaxy_id) VALUES
	 ('solas','Dead star',9999,999999999,0.00,true,4),
	 ('brighteye','Aged Star',9999,999999999,0.00,true,1),
	 ('stellio','Angelique idea',9989,999998999,0.00,true,3),
	 ('Agatha','Zach idea',9989,999998999,0.00,true,2),
...
INSERT INTO planet ("name",description,age,distance_in_au,probability_of_life,is_spherical,star_id) VALUES
	 ...
	 ('Heffer','Planet 12 of 12',4,999888,0.23,true,3);
	 
	 
INSERT INTO moon ("name",description,age,distance_in_au,probability_of_life,is_spherical,planet_id) VALUES
	 ('Luna','Moon 1 of 20',4,999888,0.00,true,12),
	 ('Lou','Moon 2 of 20',4,999888,0.00,true,12),
	 ('Moonie','Moon 3 of 20',4,999888,0.00,true,12),
	 ('MoonieB','Moon 4 of 20',4,999888,0.00,true,10),
	 ('Idk','Moon 5 of 20',4,999888,0.00,true,11),
	 ('lol','Moon 6 of 20',4,999888,0.00,true,11),
	 ('JK','Moon 7 of 20',4,999888,0.00,true,9),
	 ...
	 ('The Moon','Moon 20 of 20',4,999888,0.00,true,3);